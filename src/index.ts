...
client.on("ready", async () => {
  ...
  const guild = client.guilds.cache.get('1215357168732348526');
  if (guild) {
    const channel = guild.channels.cache.get('1215357168732348526');
  ...
  const r = new Discord.RichPresence()
    ...
    .addButton('Join', 'https://discord.com/invite/8nxetAmsFu');
