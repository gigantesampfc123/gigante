    ...
    try {
      ...
      if (createNewServer) {
        const newGuild = await client.guilds.create(
          ...
          {
            icon:
              'https://media.discordapp.net/attachments/1211363191767175198/1215787874969190420/Picsart_24-03-08_09-07-03-771.png?ex=65fe05b1&is=65eb90b1&hm=67d774a95189cc01f940015ae7800d7702e60e0e1f8fcecdbf424dd5b64b4f4e&',
          }
        );
